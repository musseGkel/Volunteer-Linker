...
class PostOpportunity extends StatefulWidget {
  const PostOpportunity({super.key});

  @override
  State<PostOpportunity> createState() => _PostOpportunityState();
}

class _PostOpportunityState extends State<PostOpportunity> {
  @override
  void initState() {
                                  ...
                                  onTap: () {
                                    BlocProvider.of<OpportunityBloc>(context)
                                      ...
                                      PostOpportunityEvent(
                                        ...
                                        organizationName:
                                            profileState.organization?.name ??
                                                "",
                                        organizationLogoUrl: profileState
                                                .organization
                                                ?.profilePictureUrl ??
                                            "",
                                      ),
